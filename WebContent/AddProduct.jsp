			...
			<div class="agileinfo_mail_grids">
				...
				<div class="col-md-8 agileinfo_mail_grid_right">
					<form action="${pageContext.request.contextPath}/AddProductsServlet" method="post">
						...
						<table>
						<tr>
							<td><label>Product Name</label></td><td><input type="text" name="ProductName"   required></td>
							...
							<td>
							 ...
							 <select name="OptionProductCategory">
							<%try{
						 ...
						 <%}
						  while(r.next())
							...
							%>
							  ...
							  <tr colspan="2"><td><br/></td></tr>
							  <tr>
							<td><label>Product Listing Description</label></td>
							
							<td><input type="text" name="ProductListingDescription"    required/></td>
							...
							<td><textarea  name="ProductDetailDescription"   required>Detail Description...</textarea></td>
							</tr>
							<tr colspan="2"><td><br/></td></tr>
							<tr>
							<td>
							...
							<input type="submit" name ="buttonaddproduct" value="Add Product"></td>
							</tr>
						</table>
